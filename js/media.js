...
const MediaData = (() => {
  ...
  const texts = [
    ...
    },
    {
      ...
      title: 'ناناعتمم',
      date: '1405/06/01',
      body: 'آیداجونمم من چندین روزه چشم به راهم بهم عکش بیدی اما چیزی نیستت😕💔😭\n\nهعبب ناناعتمم:)\n\nاز زیر بغلت هم میشهه مرگ من عکش بیدیی تروجون من از زیر بغل نام نامیت عکش بیدیی🤭😋😋'
    },
    {
      id: 't4',
      title: 'چیزی که الان میخواستم بگم',
      date: '1405/06/01',
      body: 'میگم دیر گفتی شوخیه من داشتم به س.ک. فکر میکردم با تو که یکم اب..م اومد💔😕\n\nمیخواستم فردا نماز بخونم صبح که دیگه اب..م اوردی😂'
    }
  ];
